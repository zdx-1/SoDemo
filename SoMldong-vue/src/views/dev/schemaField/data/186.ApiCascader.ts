export default {
  ...
  props: [
    ...
    {
      field: 'ext.asyncFetchParamKey',
      label: '异步请求参数',
      labelWidth: '110px',
      helpMessage: ['懒加载异步请求参数的key', '默认为parentCode'],
      component: 'Input',
      colProps: {
        xl: 12,
        xxl: 12,
    ...
    {
      field: 'ext.isLoadData',
      labelWidth: '110px',
      component: 'Checkbox',
      renderComponentContent: '是否动态加载',
      defaultValue: true,
      colProps: {
        xl: 8,
        xxl: 8,
    ...
    {
      field: 'ext.showSearch',
      labelWidth: '110px',
      component: 'Checkbox',
      renderComponentContent: '是否可搜索',
      defaultValue: true,
      colProps: {
        xl: 8,
        xxl: 8,
