<template>
  <PageWrapper>
          ...
          :actions="[
            {
              ...
              auth: ['admin', 'sys:post:save'], // 根据权限控制是否显示: 无权限，不显示
            },
          ]"
          :dropDownActions="[
            {
              ...
              auth: ['admin', 'sys:post:remove'], // 根据权限控制是否显示: 有权限，会显示
            },
          ]"
        >
          <template #more>
          ...
          :actions="[
            {
              ...
              auth: ['admin', 'sys:post:update'], // 根据权限控制是否显示: 无权限，不显示
            },
          ]"
          :dropDownActions="[
            {
    ...
    ><sysPostAdd @register="registerAddModal" @success="handleSuccess"
  /></PageWrapper>
</template>
...
<script setup>
  ...
  import { sysPostDel, sysPostPage } from '/@/api/sys/post';
  import sysPostAdd from './add.vue';
