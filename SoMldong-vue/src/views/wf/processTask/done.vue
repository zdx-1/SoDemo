          ...
          :actions="[
            {
              ...
              auth: ['admin', 'wf:processTask:doneDetail'], // 根据权限控制是否显示: 无权限，不显示
            },
          ]"
        />
      </template>
    </BasicTable>
    <Detail @register="registerDetailDrawer" @success="handleSuccess" type="done" />
  </PageWrapper>
</template>

<script setup>
  import { BasicTable, useTable, TableAction } from '/@/components/Table';
  import { wfProcessTaskDoneList } from '/@/api/wf/processTask';
